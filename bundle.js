...
/***/ function(module, exports, __webpack_require__) {
	...
	var _radioComponent = __webpack_require__(2);
	...
	var _tapEvent = __webpack_require__(14);

	var _tapEvent2 = _interopRequireDefault(_tapEvent);

	var _pinchZoom = __webpack_require__(15);
	...
	var _domify = __webpack_require__(31);

	var _domify2 = _interopRequireDefault(_domify);

	var _propDetect = __webpack_require__(20);
	...
	var ImagesPreview = function (_Emitter) {
	  ...
	  function ImagesPreview(imgs) {
	    ...
	    _this.status = [];
	    _this.loaded = [];
	    if (opts.bind !== false) _event2.default.bind(document, 'touchstart', _this._ontap);
	    return _this;
	  }
	  /**
	   * ontap event handler
	  ...
	  _createClass(ImagesPreview, [{
	      ...
	      if (!state) {
	        (function () {
	          ...
	          if (animate) {
	            ...
	            var holder = _this2.holder = document.createElement('div');
	          ...
	          var image = _this2.createImage(wrapper, img.src);
	          ...
	          pz.draggable = false;
	          _this2.loadImage(image, wrapper).then(function () {
	            _this2.loaded.push(idx);
	            pz.draggable = true;
	          }, function () {});
	        })();
	      }
	    ...
	    value: function hide() {
	      ...
	      setTimeout(function () {
	        document.body.removeChild(_this4.container);
	      }, 100);
	    }
	    /**
	     * unbind tap event
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tap = __webpack_require__(14)
	var raf = __webpack_require__(7)
	var Tween = __webpack_require__(8)
	var detect = __webpack_require__(20)
	var util = __webpack_require__(25)
	var Pinch = __webpack_require__(26)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.transition = __webpack_require__(21)

	exports.transform = transform

	exports.touchAction = __webpack_require__(22)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoscaleCanvas = __webpack_require__(30);
